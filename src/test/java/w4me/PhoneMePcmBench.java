...
public final class PhoneMePcmBench {
    ...
    private static final int[] WATERNET_DURATIONS = {
        50, 0, 8, 50, 8, 8, 8, 8, 50, 8, 50, 50, 8, 50
    };
    private static final int[] WATERNET_VOLUMES = {
        75, 100, 100, 75, 100, 100, 100, 100, 75, 100, 75, 75, 100, 75
    };
    private static final int[] WATERNET_FLAGS = {
        1, 65, 0, 1, 0, 0, 0, 0, 1, 0, 1, 1, 0, 1
    };

    private static final int[] RUBIDO_FREQUENCIES = {
        0, 900, 900, 1000, 900, 900, 600, 600
    };
    private static final int[] RUBIDO_DURATIONS = {
        0, 8, 8, 8, 8, 8, 8, 8
    };
    private static final int[] RUBIDO_VOLUMES = {
        0, 100, 100, 100, 100, 100, 100, 100
    };
    private static final int[] RUBIDO_FLAGS = {
        0, 0, 0, 0, 0, 0, 0, 0
    };
    ...
    private static final int[] SLIDE_DURATIONS = {
        60, 60, 60, 60
    };
    private static final int[] SLIDE_VOLUMES = {
        25700, 25700, 25700, 25700
    };
    private static final int[] SLIDE_FLAGS = {
        0, 0, 0x40, 0x43
    };

    private static final int[] ADSR_FREQUENCIES = {
        440, 900, 262, 600
    };
    ...
    private static final int[] ADSR_VOLUMES = {
        (100 << 8) | 80,
        (70 << 8) | 50,
        (100 << 8) | 75,
        (90 << 8) | 60
    };
    private static final int[] ADSR_FLAGS = {
        0, 1, 2, 3
    };
    ...
    public static void main(String[] arguments) {
        ...
        if (cycles <= 0 || sample < 0) {
            throw new IllegalArgumentException(
                    "cycles must be positive and sample non-negative");
        }
