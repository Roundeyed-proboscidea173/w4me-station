...
public final class PhoneMeArgbBandBench {
    public static void main(String[] arguments) throws Exception {
        ...
        int rowsPerBand =
                bandHeight > side ? side : bandHeight;
    ...
    private static void initializeFramebuffer(
            byte[] memory) {
        int[] colors =
                {0x071821, 0x306850, 0x86c06c, 0xe0f8cf};
        int index;
